...
(function() {
    ...
    const cheevosNotify = `<span style="cursor:pointer" onclick="document.getElementById('achievement_block').scrollIntoView()">🏆 {0} Başarım.</span>`;
    ...
    const delistedNotify = `<span title="Bu ürün satın alınamaz.">👻 Dizme dışı.</span>`;
